...
export default async function SessionsListPage({
  ...
  // Real path: simpler Link-list for the populated case, plus the
  // empty-state StartSessionMenu (from #91). Expandable session
  // detail in real mode requires fetching breakthroughs / shifts /
  // goals per session — queued as a V.5a follow-up.
  if (!isDemo) {
